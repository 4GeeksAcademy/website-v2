...
export default props =>
    <svg className={props.className} style={props.style} width={props.width} height={props.height} viewBox="0 0 32 31" fill="none" xmlns="https://www.w3.org/2000/svg">
        ...
        <defs>
            <clipPath id="clip0">
                <rect width="14.1584" height="8.35001" fill="white" transform="translate(12 22.8269) rotate(-90)" />
            </clipPath>
        </defs>
    </svg>
