...
export const GridContainer = ({fluid, shadow, children, display, display_tablet, background, borderRadius, backgroundChild, gridGap, gridGap_tablet, gridTemplateRows, gridTemplateRows_tablet, height, height_tablet, columns, columns_tablet, margin, margin_tablet, padding, padding_tablet, paddingChild, padding_tabletChild}) => {
    return (
        <Grid background={background} shadow={shadow} borderRadius={borderRadius} display={display} display_tablet={display_tablet} height={height} height_tablet={height_tablet} margin={margin} margin_tablet={margin_tablet} padding={padding || "0 17px"} padding_tablet={padding_tablet || "0"}>
