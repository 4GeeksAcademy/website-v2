...
const BurgerIcon = (props) => <svg width="28" height="23" style={props.style} viewBox="0 0 28 23" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <>
            <Nav display_md="none" display="flex">
                <Div alignItems="center">
                    <BurgerIcon style={{marginRight: "16px", cursor: "pointer"}} />
                    <Link to={'/'}>
                        <Img
                            fadeIn={false}
                            loading="eager"
