...
export default props => {
  ...
  return (
    <GridContainer height="375px" height_tablet="219px" background={Colors.verylightGray} columns="2" padding="0" columns_tablet="4" margin="0 0 67px 0" margin_tablet="0 0 57px 0">
