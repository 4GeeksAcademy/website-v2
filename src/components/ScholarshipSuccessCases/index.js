  ...
  return (
    <Div display="block" margin="0 0 10px 0">
      ...
      <Div padding="0 40px">
        ...
        <Div display="block" width="282px" borderRadius="4px" border={`2px solid ${Colors.lightGray}`}>
          <Div width="100%">
            <StyledBackgroundSection
              ...
              image={
                student.img &&
                student.img.childImageSharp.gatsbyImageData
              }
              bgSize="cover"
            />
          </Div>
          <Div display="block" padding="17px">
            <Div justifyContent="between">
              <H4 fontWeight="700" textAlign="left">{student.name}</H4>
              <Div alignItems="center" padding="3px" background={Colors.veryLightBlue}>
                <Icon icon="graduation" width="19px" height="16px" fill={Colors.blue} />
            ...
            <Div>
              ...
              <Paragraph margin="0 0 0 10px" textAlign="left" color={Colors.black}>
