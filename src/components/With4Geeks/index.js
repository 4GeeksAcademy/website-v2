...
export default ({lang, playerHeight, title, text, text_link, paragraph, background, sessionLocation}) => {
  ...
  return (
    <Fragment github="/components/with_4geeks">
      ...
      {locationFiltered && (
        <GridContainer columns_tablet={locationFiltered.length <= 3 ? locationFiltered.length : "3"} margin="0 0 73px 0" margin_tablet="0 0 84px 0">
