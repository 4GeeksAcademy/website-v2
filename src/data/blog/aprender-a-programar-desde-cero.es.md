...
<call-to-action button_text="Ver programa" button_link="#" background="rgba(0, 151, 205, 0.15)" title="Impulsa tu carrera, gracias a la programación" text="Te invitamos a impulsar tu carrera, aprendiendo a programar con nuestro Programa Full-Stack Developer."></call-to-action>
...
1. **Desarrollador backend:** Se enfoca en diseñar, implementar y estructurar la lógica funcional de un sistema que funciona en alguna máquina o dispositivo ubicado de forma remota del usuario final.
