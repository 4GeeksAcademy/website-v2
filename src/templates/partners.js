        ...
        <>
            ...
            >
                ...
                >
                    ...
                    {Array.isArray(
                        partnersData.benefits_and_charts.bullets
                    ) && (
                        <Div
                            display="flex"
                            flexDirection="column"
                        ...
                        >
                            {partnersData.benefits_and_charts.bullets.map(
                                (p, index) => (
                                    <Div
                                        key={index}
                                        borderBottom={`${
                                            index !==
                                            partnersData.benefits_and_charts
                                                .bullets.length -
                                                1
                                                ? "1px solid #EBEBEB"
                                                : "0"
            ...
            >
                ...
                <Grid
                    ...
                    padding="0 10% 0 6%"
                >
                    {partnersData.partners_in_education.image_list.map(
                        (l, index) => (
                            <Div
                                key={index}
                                width="235px"
