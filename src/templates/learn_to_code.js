...
import {Container, Header, Column, Wrapper, WrapperImage, Divider, Div, GridContainer} from '../new_components/Sections'
...
const LearnToCode = ({data, pageContext, yml}) => {
  ...
  return (<>
    ...
    {/* <ProgramDetails details={pageDetails.details} lang={pageContext.lang} course={program_type} /> */}
    {/* <ProgramDetailsMobile details={pageDetails.details} lang={pageContext.lang} course={program_type} /> */}
    ...
    <UpcomingDates lang={pageContext.lang} message={pageDetails.upcoming.no_dates_message} />
...
export const query = graphql`
  query LearnToCodeQuery($file_name: String!, $lang: String!) {
...
export default BaseRender(LearnToCode);