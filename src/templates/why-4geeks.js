...
const Why4Geeks = (props) => {
    ...
    return (
        <>
            <GridContainerWithImage background={Colors.lightBlue} padding="24px 17px " padding_tablet="36px 0 54px 0" columns_tablet="14" margin="120px 0 24px 0" margin_tablet="0">
