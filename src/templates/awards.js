...
const SVGImage = () =>
    <svg width="100%" height="284" viewBox="0 0 419 284" fill="none" xmlns="https:://www.w3.org/2000/svg">
...
const Awards = ({data, pageContext, yml}) => {
    return (
        <>
            ...
            <GridContainer padding_tablet="80px 0" padding="60px 17px 80px 17px" background="rgba(199, 243, 253, 0.5)" margin="60px 0 0 0">
                <Div 
