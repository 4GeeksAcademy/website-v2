...
exports.sourceNodes = async ({ actions, createNodeId, createContentDigest }, config) => {
    ...
    posts.forEach(async post => {
        ...
        const frontMatter = {
          ...
          cluster: Array.isArray(post.clusters) && post.clusters.length > 0 ? post.clusters[0] : defaultCluster[post.lang],
        }
